...
CREATE TABLE usuarios (
  ...
  unidadID INT(5) NOT NULL, FOREIGN KEY(unidadID) REFERENCES unidades(id),
  rolID INT(2) NOT NULL, FOREIGN KEY(rolID) REFERENCES roles(id),
...
CREATE TABLE devengos (
  ...
  usuarioID INT(10) NOT NULL, FOREIGN KEY(usuarioID) REFERENCES usuarios(id),
  contratoID INT(10) NOT NULL, FOREIGN KEY(contratoID) REFERENCES contratos(id),
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
( "ABASTO", "COORDINACION DE ABASTECIMIENTO"),
( "CSS", "CENTRO DE SEGURIDAD SOCIAL"),
( "GUARDERIA", "GUARDERIA ORDINARIA"),
( "CEDECAL", "CENTRO DE CAPACITACION"),
( "SUBNTE", "SUBDELEGACION METROPOLITANA NORTE"),
( "SUBSUR", "SUBDELEGACION METROPOLITANA SUR");
